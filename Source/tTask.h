...
#define	zunxOS_TASK_STATE_RDY					0
#define zunxOS_TASK_STATE_DESTROYED             (1 << 0)
#define	zunxOS_TASK_STATE_DELAYED				(1 << 1)
#define zunxOS_TASK_STATE_SUSPEND               (1 << 2)

#define zunxOS_TASK_WAIT_MASK                   (0xFF << 16)
...
typedef struct _tTask {
	...
	// 在zunxOS运行该任务前，会从stack指向的位置处，会读取堆栈中的环境参数恢复到CPU寄存器中，然后开始运行
